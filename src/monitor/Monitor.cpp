  ...
  Application(argc, argv)
{
  ...
  overviewLayout->addWidget(
      new Label("<b>CPU Model:</b> " + _cpuMon->getModel()));
  overviewLayout->addWidget(
      new Label(
          "<b>CPU Cache:</b> " + toString(_cpuMon->getCacheSize()) + " KB"));
  ...
  memGroup->addWidget(
      new Label("<b>Total:</b> " + toString(_memMon->getTotal()) + " MB"));
  memGroup->addWidget(
      new Label("<b>Cached:</b> " + toString(_memMon->getCached()) + " MB"));
  memGroup->addWidget(
      new Label("<b>Free:</b> " + toString(_memMon->getFree()) + " MB"));
  memGroup->addWidget(
      new Label("<b>Buffers:</b> " + toString(_memMon->getBuffers()) + " MB"));
  ...
  fsGroup->addWidget(
      new Label("<b>Total:</b> " + toString(_fsMon->getTotal()) + " GB"));
  fsGroup->addWidget(
      new Label("<b>Free:</b> " + toString(_fsMon->getFree()) + " GB"));
